...
that stopped resolving; whether the prose is true and consistent is the read. An
agent needs telling how, having been in the conversation the whole time with no
