...
(ng-atom-one-dark-with-color-variables
 (custom-theme-set-faces
  ...
  `(magit-section-heading ((t (:foreground ,yellow :background ,black :weight bold))))
  `(magit-section-heading-selection ((t (:foreground ,yellow :background ,black :weight bold :underline t))))
  `(magit-diff-file-heading ((t (:foreground ,white :background ,black))))
  `(magit-diff-file-heading-highlight ((t (:foreground ,white :background ,black))))
  `(magit-diff-file-heading-selection ((t (:foreground ,white :background ,black :underline t))))
  `(magit-diff-hunk-heading ((t (:foreground ,white :background ,black))))
  `(magit-diff-hunk-heading-highlight ((t (:foreground ,white :background ,black))))
  `(magit-diff-hunk-heading-selection ((t (:foreground ,white :background ,black :underline t))))
